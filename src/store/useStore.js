...
export const setClientGUID = (clientGUID) => useStore.getState().authActions.setClientGUID(clientGUID);
export const setClientID = (clientID) => useStore.getState().authActions.setClientID(clientID);
...
export const setGlobalLoading = (o, i) => useStore.getState().uiActions.setGlobalLoading(o, i);
export const getAppMode = () => useStore.getState().setting.appMode;
export const setAppMode = (mode) => useStore.getState().settingActions.setAppMode(mode);
